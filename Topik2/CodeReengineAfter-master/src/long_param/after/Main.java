...
public class Main {
	...
	public void cekSaldo() { 
		walletNotif.balanceNotif(user, 0, user.getWallet().getBalance());
	...
	public void tambahSaldo() {
		...
		walletNotif.balanceNotif(user,saldoTambahan, user.getWallet().getBalance());
		pressEnterToContinue();
	}
	...
	public void tarikSaldo() {
		...
		walletNotif.balanceNotif(user, penguranganSaldo, user.getWallet().getBalance());
		pressEnterToContinue();
	}
